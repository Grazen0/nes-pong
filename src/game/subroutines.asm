...
.proc reset_ball
    .importzp ball_x, ball_y, ball_speed_x, ball_speed_y   ; game/variables.asm
    .import random_byte     ; lib/random.asm
...
.proc draw_player_a_score
    .import update_bg_buf_ptr   ; lib/nes/bg_buffer.asm
    .importzp player_a_score    ; game/variables.asm
    ...
    jmp    update_bg_buf_ptr
.endproc

.proc draw_player_b_score
    .import update_bg_buf_ptr   ; lib/nes/bg_buffer.asm
    .importzp player_b_score    ; game/variables.asm
...
.export reset_ball, draw_player_a_score, draw_player_b_score
